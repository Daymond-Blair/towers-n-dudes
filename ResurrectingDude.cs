...
{
    class ResurrectingDude : IDude
    {
        private AverageDude _incarnation1;
        private BuffDude _incarnation2;
        ...
        public ResurrectingDude(Path path)
        {
            _incarnation1 = new AverageDude(path);
            _incarnation2 = new BuffDude(path);
        }
